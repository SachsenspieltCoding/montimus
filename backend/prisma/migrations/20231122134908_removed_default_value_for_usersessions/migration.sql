...
INSERT INTO "new_UserSessions" ("createdAt", "expiresAt", "id", "jwt", "name", "updatedAt", "userId") SELECT "createdAt", "expiresAt", "id", "jwt", "name", "updatedAt", "userId" FROM "UserSessions";
